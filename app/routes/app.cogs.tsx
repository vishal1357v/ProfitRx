...
import { CogsApplicationService } from "../application/cogs/cogs.application";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  return CogsApplicationService.getCogsCatalog(shop, admin, email);
};
...
function CogsInput({ initialValue, onChange }: CogsInputProps) {
